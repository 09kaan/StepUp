...
void _appSettingSerialize(
  ...
  writer.writeLong(offsets[0], object.dailyStepGoal);
}
...
AppSetting _appSettingDeserialize(
  ...
  object.dailyStepGoal = reader.readLong(offsets[0]);
  object.id = id;
  return object;
}
...
extension AppSettingQuerySortBy
  ...
  QueryBuilder<AppSetting, AppSetting, QAfterSortBy> sortByDailyStepGoal() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dailyStepGoal', Sort.asc);
    });
  }

  QueryBuilder<AppSetting, AppSetting, QAfterSortBy> sortByDailyStepGoalDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension AppSettingQuerySortThenBy
  ...
  QueryBuilder<AppSetting, AppSetting, QAfterSortBy> thenByDailyStepGoal() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dailyStepGoal', Sort.asc);
    });
  }

  QueryBuilder<AppSetting, AppSetting, QAfterSortBy> thenByDailyStepGoalDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dailyStepGoal', Sort.desc);
    });
  }
...
extension AppSettingQueryWhereDistinct
  ...
  QueryBuilder<AppSetting, AppSetting, QDistinct> distinctByDailyStepGoal() {
    return QueryBuilder.apply(this, (query) {
...
extension AppSettingQueryProperty
  ...
  QueryBuilder<AppSetting, int, QQueryOperations> dailyStepGoalProperty() {
    return QueryBuilder.apply(this, (query) {
